...
void create_dosbox_ui()
{
  ...
  gotoxy(32, 2);
  print_color_string("Welcome to My OS", WHITE, BRIGHT_BLUE);

  gotoxy(35, 4);
  print_color_string("Created By : ", WHITE, BRIGHT_BLUE);

  gotoxy(25, 5);
  print_color_string("Rifqy Adli Damhuri (55417203) ", WHITE, BRIGHT_BLUE);

  gotoxy(25, 6);
  print_color_string("Vika Putri Ariyanti (56417094)", WHITE, BRIGHT_BLUE);
  
  gotoxy(30, 8);
  print_color_string("Universitas Gunadarma", WHITE, BRIGHT_BLUE);

  gotoxy(40, 9);
  print_color_string("2020", WHITE, BRIGHT_BLUE);

  fill_box(0, 25, 13, BOX_MAX_WIDTH - 49, 5, BLUE);
  draw_box(BOX_DOUBLELINE, 25, 13, BOX_MAX_WIDTH - 50, 3, WHITE, BLUE);
